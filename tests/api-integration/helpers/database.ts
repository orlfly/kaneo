...
// Query Postgres directly. The catalog is the canonical source of what tables
// actually exist after migrations run. Reflecting on the schema object in
// apps/api/src/database misses any table that is not exported from the
// index.ts registry (for example mcp_oauth_state and task_reminder_sent).
