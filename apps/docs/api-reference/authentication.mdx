...
```bash
curl -X GET https://your-kaneo-instance.com/api/task?teamId=your-team-id \
...
```javascript
const response = await fetch('https://your-kaneo-instance.com/api/task?teamId=your-team-id', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer your-api-key-here',
