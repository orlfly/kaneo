...
- [ ] 5.1 集成测试：对本地 Kaneo 实例跑一次完整同步（7 角色全选），断言 7 个 assistant 创建、context 含 AGENTS.md 正文、skill 启用符合 for_roles
- [ ] 5.2 幂等测试：同一实例二次同步，断言 update 而非 duplicate（assistant 总数不变）
